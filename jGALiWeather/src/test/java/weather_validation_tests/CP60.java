...
public class CP60 {
    ...
    public void test() {
        ...
        try {
             ...
             *   para esta época del año, con mínimas en ascenso moderado y máximas en ascenso notable.
             */
            assertEquals(salida, "Clear skies in general for the next few days, although it will occasionally be partly cloudy. Temperature will be normal for this period of the year, with minimums in moderate increase and maximums in notable increase.");
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
