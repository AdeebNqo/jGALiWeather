...
public class CP48 {
    ...
    public void test() {
        ...
        try {
             ...
             */
            assertThat(salida, anyOf(is("With respect to air quality state, it is expected to change to hazardous, to due the sunny and stable weather in the coming days."), 
                    is("With respect to air quality state, it is expected to change to hazardous, to due the sunny and stable weather in the next few days.")));
        } catch (Exception ex) {
