...
public class CP32 {
    ...
    public void test() {
        ...
        try {
             ...
             */
            assertThat(salida, anyOf(is("With respect to air quality state, it is expected to change to admissible, to due the dry weather during the coming days."), 
                    is("With respect to air quality state, it is expected to change to admissible, to due the dry weather during the next few days.")));
        } catch (Exception ex) {
