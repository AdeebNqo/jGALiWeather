...
public class CP18 {
    ...
    public void test() {
        ...
        SkyCoverageGeneratorLevel1 nssg = new SkyCoverageGeneratorLevel1(tr.getLabelsets().get("C1"), tr.getLabelsets().get("C"), partitions.get("SSFTP"), tr.getLabelsets().get("SSFTP"), nssa_output);
