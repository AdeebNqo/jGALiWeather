...
public class CP24 {
    ...
    public void test() {
        ...
        TemperatureGenerator t_nlg = new TemperatureGenerator(tr.getLabelsets().get("T"), tr.getLabelsets().get("CT"), tr.getLabelsets().get("V"), tr.getLabelsets().get("VAR"), partitions.get("VAR"), t_output.getClim_eval(), t_output.getVariation_eval(), t_output.getVariability_eval());

        String salida = t_nlg.parseAndGenerate();
