...
public class CP20 {
    ...
    public void test() {
        ...
        try {
            ...
            RainGenerator nssg = new RainGenerator(tr.getLabelsets(), Calendar.getInstance(), vr.getVariables().get("Meteoro").getActual_data_length(), r_output, nlgFactory);
            ...
            Logger.getLogger(CP20.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
