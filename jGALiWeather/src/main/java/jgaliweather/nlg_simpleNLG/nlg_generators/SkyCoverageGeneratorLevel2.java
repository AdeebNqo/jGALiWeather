    ...
    public NLGElement generate() {
        ...
        if (Arrays.equals(l_description[0], aux1)) {
            ...
            if (l_description[2][1] > 0.1 || l_description[2][2] > 0.1) {
                ...
                second_part.addPreModifier(nlgFactory.createAdverbPhrase(template.getLabels().get("occasionally").getData()));
            ...
            SPhraseSpec text = nlgFactory.createClause(template.getLabels().get("subject2").getData(),
                    template.getLabels().get("expected").getData());
            ...
            NPPhraseSpec dep = nlgFactory.createNounPhrase(template.getLabels().get("period2").getData());
            ...
            NPPhraseSpec state2 = nlgFactory.createNounPhrase(template.getLabels().get("other").getData(), template.getLabels().get("period2").getData());
            ...
            NPPhraseSpec subject = nlgFactory.createNounPhrase(template.getLabels().get("the").getData(), template.getLabels().get("state").getData());
            ...
            variable.addPreModifier(nlgFactory.createAdverbPhrase(template.getLabels().get("very").getData()));
            ...
            term.addPreModifier(nlgFactory.createAdjectivePhrase(template.getLabels().get("whole").getData()));
